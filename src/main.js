...
const myBot = ['ubab5061d8fec0543a783f421e15341c3'];
...
=> !yousound\n\
=> !youtube\n\
\n\n# http://line.me/ti/p/jameshakim1  ^_^";
        var that = this;
    }
...
\n";
        ...
        }else if(txt === 'nah' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
